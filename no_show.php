...
if ($result && $result->num_rows > 0) {
    ...
    $insert_sql = "
        INSERT INTO past_patients (token_number, name, case_description, emergency, registration_date, no_show)
        VALUES ('{$patient['token_number']}', '{$patient['name']}', '{$patient['case_description']}', '{$patient['emergency']}', '{$patient['registration_date']}', 'yes')
    ";
